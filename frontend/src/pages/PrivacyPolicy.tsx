    ...
    return (
        <>
            ...
            <div className="max-w-4xl mx-auto px-6 py-12">
                ...
                <p className="mb-6">Last updated: July 28, 2026</p>
                ...
                <section className="mb-8">
                    ...
                    <p className="mb-4">
                        We do not sell, trade, or otherwise transfer your personal information to third parties without your consent, except as described in this policy or as required by law. Advertising partners such as Google and Apitiny may receive technical information (for example, cookies and device data) as described under Advertising above.
                    </p>
                </section>
